...
(function($) {
    ...
    $.googlePlaces = function(element, options) {
        ...
        var defaults = {
              placeId: 'ChIJtdnQhfz70YURO0HWuHL7XsE' // placeId provided by google api documentation
            , render: ['reviews']
            , min_rating: 0
            , max_rows: 0
        ...
        var renderReviews = function(reviews){
          ...
          for (var i = row_count; i >= 0; i--) {
            ...
            html = html+"<div class='review-item'><div class='review-meta'><i class='fas fa-user fa-2x d-block'></i><span class='review-author'>"+name+"<span class='review-date'>"+date+"</span></div>"+stars+"<p class='review-text'>"+reviews[i].text+"</p></div>"
          };
          $element.append(html);
        }
